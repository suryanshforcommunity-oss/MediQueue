...
import { Activity, User, Stethoscope, Eye, EyeOff, Loader2 } from "lucide-react"
            ...
            <TabsContent value="patient">
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Access your appointments and medical records</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="doctor">
              <Card className="border-0 shadow-lg">
                <CardHeader>
                  ...
                  <CardDescription>Access your patient queue and appointments</CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-2">
                  ...
                  <p className="text-center text-sm text-muted-foreground mt-6">
                    Need an account?{" "}
                    <Link href="/register?role=doctor" className="text-primary hover:underline font-medium">
                      Contact admin
                    </Link>
                  </p>
                </CardContent>
